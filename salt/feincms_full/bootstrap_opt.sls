...
{{ project_name }}_opt_static:
    file.recurse:
        - source: salt://{{ base_app }}/source/opt/static
...
# templates
{{ project_name }}_opt_templates:
    file.recurse:
        - source: salt://{{ base_app }}/source/opt/templates
        - name: /opt/{{ project_name }}/templates/
        - user: {{ admin_user }}
        - group: {{ admin_user }}
        - unless: ls /opt/{{ project_name }}/templates
...
# search_indexes
{{ project_name }}_opt_core_application_search_indexes:
    file.managed:
        - source: salt://{{ base_app }}/source/opt/core/search_indexes.py
        - name: /opt/{{ project_name }}/core/search_indexes.py
        - template: jinja
        - user: {{ admin_user }}
        - group: {{ admin_user }}

# fixtures
{{ project_name }}_opt_core_application_fixtures:
    file.recurse:
        - source: salt://{{ base_app }}/source/opt/core/fixtures
        - name: /opt/{{ project_name }}/core/fixtures/
        - user: {{ admin_user }}
        - group: {{ admin_user }}
        - unless: ls /opt/{{ project_name }}/core/fixtures
